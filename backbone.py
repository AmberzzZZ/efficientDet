# backbone-b0 for efficientDet
# 512x512 input, 128x downSamp
...
def EfficientNet(input_tensor, drop_connect_rate=0., dropout_rate=0.):

    # stem
    x = Conv_BN(input_tensor, 32, 3, strides=2)
...
if __name__ == '__main__':
    ...
    x = Input((512,512,3))
    output, features = EfficientNet(x)
